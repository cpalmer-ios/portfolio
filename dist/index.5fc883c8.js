...
})({"fZnnY":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "4115f1095fc883c8";
"use strict";
...
var _textAnimatorJs = require("./text-animator.js");
"use strict";
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    (0, _gsap.gsap).registerPlugin(ScrollTrigger);
});
...
/* Question button click */ (function() {
    ...
    document.querySelectorAll('.list__item').forEach((item)=>{
        ...
        const animators = cols.map((col)=>new (0, _textAnimatorJs.TextAnimator)(col));
    ...
    document.querySelectorAll('a.hover-effect').forEach((item)=>{
        const animator = new (0, _textAnimatorJs.TextAnimator)(item);
        item.addEventListener('mouseenter', ()=>{
            animator.animate();
        });
        item.addEventListener('mouseleave', ()=>{
...
},{"gsap":"fPSuC","./text-animator.js":"h7Ab9"}],"fPSuC":[function(require,module,exports,__globalThis) {
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"h7Ab9":[function(require,module,exports,__globalThis) {
// Import the TextSplitter class for handling text splitting.
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
// Defines a class to create hover effects on text.
parcelHelpers.export(exports, "TextAnimator", ()=>TextAnimator);
var _gsap = require("gsap");
var _textSplitterJs = require("./textSplitter.js");
...
class TextAnimator {
    ...
    splitText() {
        ...
        this.splitter = new (0, _textSplitterJs.TextSplitter)(this.textElement, {
    ...
    animate() {
        ...
        (0, _gsap.gsap).fromTo(this.textElement, {
            '--anim': 0
        }, {
            duration: 1,
            ease: 'expo',
    ...
    animateBack() {
        (0, _gsap.gsap).killTweensOf(this.textElement); // Ensure no ongoing animations
        (0, _gsap.gsap).to(this.textElement, {
            duration: .6,
            ease: 'power4',
            '--anim': 0
        });
    ...
    reset() {
        ...
        chars.forEach((char, index)=>{
            (0, _gsap.gsap).killTweensOf(char); // Ensure no ongoing animations
            char.innerHTML = this.originalChars[index];
        });
        (0, _gsap.gsap).killTweensOf(this.textElement);
        (0, _gsap.gsap).set(this.textElement, {
            '--anim': 0
        });
    }
}
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["fZnnY","g2DDQ"], "g2DDQ", "parcelRequire94c2")

//# sourceMappingURL=index.5fc883c8.js.map
