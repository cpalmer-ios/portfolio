...
})({"d7EZr":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "4f3dda52f4eb26ef";
"use strict";
...
},{}],"h7Ab9":[function(require,module,exports,__globalThis) {
...
class TextAnimator {
    ...
    animate() {
        ...
        chars.forEach((char, position)=>{
            ...
            TweenLite.fromTo(char, 0.03, {
                opacity: 0
            }, {
                onComplete: ()=>{
                    if (char) TweenLite.set(char, {
        ...
        if (this.textElement) TweenLite.fromTo(this.textElement, 1, {
            '--anim': 0
        }, {
            ease: Expo.easeOut,
            '--anim': 1
    ...
    animateBack() {
        ...
        TweenLite.to(this.textElement, 0.6, {
            ease: Power4.easeOut,
            '--anim': 0
        });
    }
...
},{"./textSplitter.js":"OSn7V","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["d7EZr","h7Ab9"], "h7Ab9", "parcelRequire94c2")

//# sourceMappingURL=index.f4eb26ef.js.map
