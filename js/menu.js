...
const DOM = {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    if (ScrollTrigger) {
      // In GSAP v2.1.3, we don't need to register plugins the same way as v3
      // They should be automatically available once loaded via script tags
      // This line is no longer needed: TweenMax.registerPlugin(ScrollTrigger);
    }
  });